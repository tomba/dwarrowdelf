...
{
	class D3D10ImageSlimDX : D3DImage, IDisposable
	{
		...
		public void SetBackBufferSlimDX(D3D10.Texture2D texture)
		{
			if (m_sharedTexture != null)
			{
		...
		static IntPtr GetSharedHandle(D3D10.Texture2D texture)
		{
		...
		static D3D9.Format TranslateFormat(D3D10.Texture2D texture)
		{
		...
		static bool IsShareable(D3D10.Texture2D texture)
		{
			return (texture.Description.OptionFlags & D3D10.ResourceOptionFlags.Shared) != 0;
		}
	}
}
