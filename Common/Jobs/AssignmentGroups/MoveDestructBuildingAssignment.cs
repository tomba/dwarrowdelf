...
{
	[SaveGameObjectByRef]
	public sealed class MoveDestructBuildingAssignment : MoveBaseAssignment
	{
		[SaveGameProperty]
		readonly IBuildingObject m_building;

		public MoveDestructBuildingAssignment(IJobObserver parent, IBuildingObject building)
			: base(parent, building.Environment, building.Area.Center)
		{
			m_building = building;
		}

		MoveDestructBuildingAssignment(SaveGameContext ctx)
			: base(ctx)
		{
		}
